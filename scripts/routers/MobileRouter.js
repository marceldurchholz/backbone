...
define(['domReady', 'collections/sidemenusCollection', 'views/test/TestView', 'views/login/LoginView', 'views/dashboard/DashboardView', 'views/noaccess/NoaccessView', 'views/dynamic/DynamicView', 'jqm'],
        
    function(domReady, sidemenusCollection, testView, loginView, dashboardView, noaccessView, dynamicView) {
